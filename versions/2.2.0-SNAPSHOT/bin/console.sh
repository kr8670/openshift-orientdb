...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.2.0-SNAPSHOT.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
"$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="UNKNOWN@r${buildNumber}; 2015-08-15 12:41:34+0000" -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.2.0-SNAPSHOT.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" com.orientechnologies.orient.graph.console.OGremlinConsole $*
